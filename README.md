...
<!--
  Optional "How it compares" table, kept commented out for now. The README is
  meant to stay light, so this is opt-in: drop it if it feels like too much, or
  uncomment it for a quick at-a-glance contrast.
...
- A **Cloudflare account** with a domain already added as a zone. Ideally a
  ...
  The free tier is generous enough for a small team, around ten operators. If
  Cloudflare emails you to say you have reached a limit, move to the $5 paid
  plan.
