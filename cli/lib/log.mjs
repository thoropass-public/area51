...
// `--verbose` adds the things that are usually noise — the wrangler command line
// and its full output, every skipped sub-check — for when a step is misbehaving
// and you need to see the actual calls.
