...
// removing a user needs no wrangler and no redeploy — the same live-table model
// as the `domains` table behind `./a51 black-holes`.
//
...
/**
 * Normalize and validate an address. Deliberately permissive — Cloudflare
